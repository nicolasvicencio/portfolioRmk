// icon:paintbucket | Teeny Icons https://teenyicons.com/ | Anja van Staden
import * as React from "react";

function IconPaintbucket(props: any) {
  return (
    <svg fill="none" viewBox="0 0 15 15" height="5em" width="5em" {...props}>
      <path
        fill="currentColor"
        fillRule="evenodd"
