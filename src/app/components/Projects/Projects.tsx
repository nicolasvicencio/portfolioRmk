...
export default function Projects({}: Props) {
  return (
    <article className="mt-8 w-[80%] mx-auto h-screen md:mt-0">
      <div className="flex flex-col-reverse justify-center gap-4 md:flex-row md:justify-around my-10">
      ...
      <div className="flex flex-col-reverse justify-center gap-4 md:flex-row-reverse md:justify-around">
        <div className="flex flex-col gap-4 items-center md:w-[40%] md:items-start ">
          <h4 className="font-semibold font-md my-2">Decotortas Website</h4>
          <p className="text-gray-800">
            Website for a small company dedicated to the sale of custom cakes.
